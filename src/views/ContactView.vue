...
function sendFormData(e) {
  ...
  emailjs
    .send("service_2c211ih", "template_u7zxnpw", data, option)
    .then(
      (response) => {
...
<template>
  <section class="text-gray-400 body-font relative">
    <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
      <!-- Left Section: Google Map & Address -->
      <div
      ...
      >
        ...
        <div class="relative mb-4">
          ...
          <textarea
            ...
            id="message"
            name="message"
            placeholder="Describe project details, services, etc."
        ...
        <button
          type="submit"
          :disabled="isSending"
          class="text-white bg-yellow-500 border-0 py-2 px-6 focus:outline-none hover:bg-yellow-600 rounded text-lg disabled:grayscale disabled:cursor-wait"
        >
          Submit
        </button>
