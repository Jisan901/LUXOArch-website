...
<template>
  ...
  <footer class="footer footer-center p-10"
    :class="{ 'bg-white text-black': isLightTheme, 'bg-[var(--bg-color)] text-white': !isLightTheme }">
    <nav>
      <div class="grid grid-flow-col gap-4">
        ...
        <a href="https://www.facebook.com/share/GFLhBoEMBEuLf4Na/?mibextid=wwXIfr">
        ...
        <a href="mailto:info@luxoarch.com.au">
          <svg class="fill-none stroke-current" width="24" height="24" viewBox="0 0 24 24"
      ...
      <RouterLink class="btn btn-primary bg-yellow-500 text-gray-950 btn-sm mt-4" to="/contact">Get in touch</RouterLink>
    </nav>
    <aside>
